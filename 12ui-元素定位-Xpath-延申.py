...
# 使用局部属性定位方式定位用户名输入框输入admin
driver.find_element("xpath", "//*[contains(@placeholder, '号A')]").send_keys("admin")
time.sleep(1)
# 利用文本定位方式定位访问百度网站的超链接，并点击
driver.find_element("xpath", "//*[text()='访问 百度 网站']").click()
time.sleep(1)
# 使用局部文本定位方式定位访问百度网站的超链接，并点击hao123
driver.find_element("xpath", "//*[contains(text(), 'hao')]").click()
