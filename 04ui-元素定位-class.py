...
# 使用class定位 输入用户名：admin
driver.find_element("class name", "telA").send_keys("18300000000")
# 使用class定位 输入密码：password
driver.find_element("class name", "c1").send_keys("2313231")
